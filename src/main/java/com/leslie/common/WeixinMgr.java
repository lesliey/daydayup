...
public class WeixinMgr {
   ...
   * @param picUrl
   */
  public String createImgText(String toUserName, String fromUserName, String msgType, String title, String description,
      String picUrl) {
  ...
  public String createTextMsg(String toUserName, String fromUserName, String content) {
  ...
  public WxUser getUserInfo(String openid) throws IOException {
    ...
    return restTemplate.getForObject(String
        .format("https://api.weixin.qq.com/cgi-bin/user/info?access_token=%s&openid=%s&lang=zh_CN", wxToken, openid),
        WxUser.class);
  }

  public void pushMsg(String user, String msg) throws IOException {
    // http请求方式: POST
    // https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=ACCESS_TOKEN
    TextMsg textMsg = new TextMsg();
    textMsg.setMsgtype("text");
    textMsg.setTouser(user);
    TextMsg.TextBean bean = new TextMsg.TextBean();
    bean.setContent(msg);
    textMsg.setText(bean);
    String result = restTemplate.postForObject(
        String.format("https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=%s", getAccessToken()),
        textMsg, String.class, new HashMap<>());
